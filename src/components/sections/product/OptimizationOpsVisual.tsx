...
const features = [
  { label: "Semantic SEO Engine", stat: "96%", desc: "Entity coverage score", color: "bg-emerald-500", glow: "shadow-[0_0_10px_-3px_rgba(16,185,129,0.5)]", track: 96 },
  { label: "GEO Optimization", stat: "91%", desc: "AI-search readiness", color: "bg-blue-500", glow: "shadow-[0_0_10px_-3px_rgba(59,130,246,0.5)]", track: 91 },
  { label: "Schema Intelligence", stat: "1,247", desc: "Schemas validated", color: "bg-violet-500", glow: "shadow-[0_0_10px_-3px_rgba(139,92,246,0.5)]", track: 82 },
  { label: "Quality Scoring", stat: "88%", desc: "Content quality avg", color: "bg-orange-500", glow: "shadow-[0_0_10px_-3px_rgba(234,88,12,0.5)]", track: 88 },
  { label: "Search Governance", stat: "100%", desc: "Standards compliance", color: "bg-amber-500", glow: "shadow-[0_0_10px_-3px_rgba(245,158,11,0.5)]", track: 100 },
  { label: "Optimization Monitor", stat: "4,892", desc: "Pages tracked", color: "bg-rose-500", glow: "shadow-[0_0_10px_-3px_rgba(244,63,94,0.5)]", track: 74 },
];

const INTERVAL_MS = 2600;

export default function OptimizationOpsVisual() {
      ...
      <div className="flex flex-col gap-4 p-4 sm:p-5">
        ...
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4">
          <div className="mb-3 flex items-center justify-between">
            <span className="text-[10px] font-semibold uppercase tracking-[0.08em] text-white/25">Optimization Health</span>
              ...
              <div key={f.label} className="flex flex-1 flex-col items-center gap-1.5">
                <div
                  className={cn(
                    ...
                    i === active
                      ? cn("bg-gradient-to-t from-emerald-600 to-emerald-400", current.glow)
                      : "bg-white/[0.08]"
                  )}
                  style={{
              ...
              <div className="h-1 overflow-hidden rounded-full bg-white/[0.06]">
                <div
                  className={cn(
                    ...
                    i === active
                      ? cn("bg-gradient-to-r from-emerald-600 to-emerald-400", f.glow)
                      : "bg-white/[0.08]"
                  )}
