...
const features = [
  { label: "Search Visibility", stat: "24,871", desc: "Keywords tracked", color: "bg-amber-500", glow: "shadow-[0_0_10px_-3px_rgba(245,158,11,0.5)]", track: 88 },
  { label: "Traffic Analytics", stat: "+34%", desc: "Organic growth MoM", color: "bg-emerald-500", glow: "shadow-[0_0_10px_-3px_rgba(16,185,129,0.5)]", track: 92 },
  { label: "Workflow ROI", stat: "4.2x", desc: "Return on operations", color: "bg-blue-500", glow: "shadow-[0_0_10px_-3px_rgba(59,130,246,0.5)]", track: 84 },
  { label: "Content Insights", stat: "1,847", desc: "Assets monitored", color: "bg-violet-500", glow: "shadow-[0_0_10px_-3px_rgba(139,92,246,0.5)]", track: 76 },
  { label: "SEO Health", stat: "97%", desc: "Technical score", color: "bg-orange-500", glow: "shadow-[0_0_10px_-3px_rgba(234,88,12,0.5)]", track: 97 },
  { label: "Forecasting", stat: "+22%", desc: "Projected growth Q3", color: "bg-rose-500", glow: "shadow-[0_0_10px_-3px_rgba(244,63,94,0.5)]", track: 68 },
];

const INTERVAL_MS = 2600;

export default function AnalyticsOpsVisual() {
      ...
      <div className="flex flex-col gap-4 p-4 sm:p-5">
        ...
        <div className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-4">
          <div className="mb-3 flex items-center justify-between">
            <span className="text-[10px] font-semibold uppercase tracking-[0.08em] text-white/25">Performance Trend</span>
            <span className="font-mono text-[10px] font-bold text-white/30">6 modules</span>
          </div>
              ...
              <div key={f.label} className="flex flex-1 flex-col items-center gap-1.5">
                <div
                  className={cn(
                    ...
                    i === active
                      ? cn("bg-gradient-to-t from-amber-600 to-amber-400", current.glow)
                      : "bg-white/[0.08]"
                  )}
                  style={{
              ...
              <div className="h-1 overflow-hidden rounded-full bg-white/[0.06]">
                <div
                  className={cn(
                    ...
                    i === active
                      ? cn("bg-gradient-to-r from-amber-600 to-amber-400", f.glow)
                      : "bg-white/[0.08]"
                  )}
